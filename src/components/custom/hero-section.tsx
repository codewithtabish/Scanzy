    ...
    <section className="w-full flex items-center justify-center min-h-screen relative overflow-hidden ">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center ">
        ...
        <p className="mx-auto mb-8 max-w-2xl text-lg ">
          Experience fast, accurate AI-generated content detection and plagiarism analysis in one powerful SaaS. Whether you're an educator, writer, or business, Jetson AI ensures your content stays original and secure.
        </p>

        {/* CTA Button */}
        <div className="flex justify-center md:max-w-1/2  mx-auto mt-8">
      ...
      {/* Scroll Down Icon */}
      <div className="absolute sm:bottom-14 bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce z-10">
